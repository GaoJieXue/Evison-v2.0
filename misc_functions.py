...
def save_gradient_images(gradient, file_name, path='visualization'):
    """
    ...
    # Save image
    path_to_file = os.path.join(path, file_name + '.jpg')
    save_image(gradient, path_to_file)


def save_class_activation_images(org_img, activation_map, file_name, path='visualization'):
    """
